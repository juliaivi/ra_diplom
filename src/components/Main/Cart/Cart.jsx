            ...
            <div className="col-4" key={item.item.id}>
                <div className="card catalog-item-card">
                    <div className="images">
                        <img  src={item.item.images[0]} className="card-img-top img-fluid" alt={`"${item.item.title}"`} />
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">{item.item.price}</p>
                         <NavLink to={`/catalog/${item.item.id}`} className="btn btn-outline-primary">Заказать</NavLink>
                    </div>
                </div>
            </div>
        </>
