                ...
                <div className="row">
                    ...
                    <div className="col text-right">
                        <section className="footer-contacts">
                            <h5>Контакты:</h5>
                            <Link className="footer-contacts-phone" to={`tel:${contacts.telephone}`}>{contacts.telephone}</Link>
                            <span className="footer-contacts-working-hours">{contacts.schedule}</span>
                            <Link className="footer-contacts-email" to={`mailto:${contacts.email}`}>{contacts.email}</Link>
